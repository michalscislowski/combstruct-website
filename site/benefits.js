(() => {
  ...
  if (modePicker && variant) {
    const format = new Intl.NumberFormat(document.documentElement.lang === 'en' ? 'en-GB' : 'pl-PL', {maximumFractionDigits:0});
    const update = () => {
      ...
      document.querySelector('#benefit-price-scope').textContent = mode === 'assembly'
        ? 'Combstruct 30 · OSB3 · konstrukcja z montażem'
        : 'Combstruct 30 · OSB3 · materiały bez montażu';
