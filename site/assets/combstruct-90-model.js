...
`)+`
`+m);let w=S+f+o,y=S+m+a,P=bu(r,r.VERTEX_SHADER,w),R=bu(r,r.FRAGMENT_SHADER,y);r.attachShader(v,P),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function T(C){if(i.debug.checkShaderErrors){let k=r.getProgramInfoLog(v)||"",z=r.getShaderInfoLog(P)||"",W=r.getShaderInfoLog(R)||"",F=k.trim(),O=z.trim(),D=W.trim(),Z=!0,j=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,P,R);else{let he=wu(r,P,"vertex"),Y=wu(r,R,"fragment");We("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
