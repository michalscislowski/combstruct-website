...
void main() {
	...
	`}var Ga=class extends hn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Kr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new ci(5,5,5),s=new dn({name:"CubemapFromEquirect",uniforms:ki(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Kt,blending:Un});s.uniforms.tEquirect.value=t;let o=new Rt(r,s),a=t.minFilter;return t.minFilter===_i&&(t.minFilter=Ot),new Zo(1,10,this).update(e,o),t.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){let s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,n,r);e.setRenderTarget(s)}};function A0(i){let e=new WeakMap,t=new WeakMap,n=null;function r(u,p=!1){return u==null?null:p?o(u):s(u)}function s(u){if(u&&u.isTexture){let p=u.mapping;if(p===Ko||p===jo)if(e.has(u)){let g=e.get(u).texture;return a(g,u.mapping)}else{let g=u.image;if(g&&g.height>0){let v=new Ga(g.height);return v.fromEquirectangularTexture(i,u),e.set(u,v),u.addEventListener("dispose",l),a(v.texture,u.mapping)}else return null}}return u}function o(u){if(u&&u.isTexture){let p=u.mapping,g=p===Ko||p===jo,v=p===gi||p===Oi;if(g||v){let d=t.get(u),m=d!==void 0?d.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==m)return n===null&&(n=new Ha(i)),d=g?n.fromEquirectangular(u,d):n.fromCubemap(u,d),d.texture.pmremVersion=u.pmremVersion,t.set(u,d),d.texture;if(d!==void 0)return d.texture;{let S=u.image;return g&&S&&S.height>0||v&&S&&c(S)?(n===null&&(n=new Ha(i)),d=g?n.fromEquirectangular(u):n.fromCubemap(u),d.texture.pmremVersion=u.pmremVersion,t.set(u,d),u.addEventListener("dispose",h),d.texture):null}}}return u}function a(u,p){return p===Ko?u.mapping=gi:p===jo&&(u.mapping=Oi),u}function c(u){let p=0,g=6;for(let v=0;v<g;v++)u[v]!==void 0&&p++;return p===g}function l(u){let p=u.target;p.removeEventListener("dispose",l);let g=e.get(p);g!==void 0&&(e.delete(p),g.dispose())}function h(u){let p=u.target;p.removeEventListener("dispose",h);let g=t.get(p);g!==void 0&&(t.delete(p),g.dispose())}function f(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:f}}function R0(i){let e={};function t(n){if(e[n]!==void 0)return e[n];let r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){let r=t(n);return r===null&&Gr("WebGLRenderer: "+n+" extension not supported."),r}}}function C0(i,e,t,n){let r={},s=new WeakMap;function o(f){let u=f.target;u.index!==null&&e.remove(u.index);for(let g in u.attributes)e.remove(u.attributes[g]);u.removeEventListener("dispose",o),delete r[u.id];let p=s.get(u);p&&(e.remove(p),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function a(f,u){return r[u.id]===!0||(u.addEventListener("dispose",o),r[u.id]=!0,t.memory.geometries++),u}function c(f){let u=f.attributes;for(let p in u)e.update(u[p],i.ARRAY_BUFFER)}function l(f){let u=[],p=f.index,g=f.attributes.position,v=0;if(g===void 0)return;if(p!==null){let S=p.array;v=p.version;for(let w=0,y=S.length;w<y;w+=3){let C=S[w+0],R=S[w+1],T=S[w+2];u.push(C,R,R,T,T,C)}}else{let S=g.array;v=g.version;for(let w=0,y=S.length/3-1;w<y;w+=3){let C=w+0,R=w+1,T=w+2;u.push(C,R,R,T,T,C)}}let d=new(g.count>=65535?Zr:Yr)(u,1);d.version=v;let m=s.get(f);m&&e.remove(m),s.set(f,d)}function h(f){let u=s.get(f);if(u){let p=f.index;p!==null&&u.version<p.version&&l(f)}else l(f);return s.get(f)}return{get:a,update:c,getWireframeAttribute:h}}function P0(i,e,t){let n;function r(u){n=u}let s,o;function a(u){s=u.type,o=u.bytesPerElement}function c(u,p){i.drawElements(n,p,s,u*o),t.update(p,n,1)}function l(u,p,g){g!==0&&(i.drawElementsInstanced(n,p,s,u*o,g),t.update(p,n,g))}function h(u,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,u,0,g);let d=0;for(let m=0;m<g;m++)d+=p[m];t.update(d,n,1)}function f(u,p,g,v){if(g===0)return;let d=e.get("WEBGL_multi_draw");if(d===null)for(let m=0;m<u.length;m++)l(u[m]/o,p[m],v[m]);else{d.multiDrawElementsInstancedWEBGL(n,p,0,s,u,0,v,0,g);let m=0;for(let S=0;S<g;S++)m+=p[S]*v[S];t.update(m,n,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=f}function I0(i){let e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:We("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function D0(i,e,t){let n=new WeakMap,r=new bt;function s(o,a,c){let l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=h!==void 0?h.length:0,u=n.get(a);if(u===void 0||u.count!==f){let E=function(){T.dispose(),n.delete(a),a.removeEventListener("dispose",E)};u!==void 0&&u.texture.dispose();let p=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,v=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],m=a.morphAttributes.normal||[],S=a.morphAttributes.color||[],w=0;p===!0&&(w=1),g===!0&&(w=2),v===!0&&(w=3);let y=a.attributes.position.count*w,C=1;y>e.maxTextureSize&&(C=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);let R=new Float32Array(y*C*4*f),T=new Wr(R,y,C,f);T.type=Tn,T.needsUpdate=!0;let x=w*4;for(let k=0;k<f;k++){let P=d[k],B=m[k],H=S[k],W=y*C*4*k;for(let U=0;U<P.count;U++){let O=U*x;p===!0&&(r.fromBufferAttribute(P,U),R[W+O+0]=r.x,R[W+O+1]=r.y,R[W+O+2]=r.z,R[W+O+3]=0),g===!0&&(r.fromBufferAttribute(B,U),R[W+O+4]=r.x,R[W+O+5]=r.y,R[W+O+6]=r.z,R[W+O+7]=0),v===!0&&(r.fromBufferAttribute(H,U),R[W+O+8]=r.x,R[W+O+9]=r.y,R[W+O+10]=r.z,R[W+O+11]=H.itemSize===4?r.w:1)}}u={count:f,texture:T,size:new ue(y,C)},n.set(a,u),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let p=0;for(let v=0;v<l.length;v++)p+=l[v];let g=a.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:s}}function L0(i,e,t,n,r){let s=new WeakMap;function o(l){let h=r.render.frame,f=l.geometry,u=e.get(l,f);if(s.get(u)!==h&&(e.update(u),s.set(u,h)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==h&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,h))),l.isSkinnedMesh){let p=l.skeleton;s.get(p)!==h&&(p.update(),s.set(p,h))}return u}function a(){s=new WeakMap}function c(l){let h=l.target;h.removeEventListener("dispose",c),n.releaseStatesOfObject(h),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:o,dispose:a}}var N0={[Jl]:"LINEAR_TONE_MAPPING",[$l]:"REINHARD_TONE_MAPPING",[Kl]:"CINEON_TONE_MAPPING",[gs]:"ACES_FILMIC_TONE_MAPPING",[Ql]:"AGX_TONE_MAPPING",[ec]:"NEUTRAL_TONE_MAPPING",[jl]:"CUSTOM_TONE_MAPPING"};function U0(i,e,t,n,r){let s=new hn(e,t,{type:i,depthBuffer:n,stencilBuffer:r}),o=new hn(e,t,{type:Fn,depthBuffer:!1,stencilBuffer:!1}),a=new zt;a.setAttribute("position",new Tt([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Tt([0,2,0,0,2,0],2));let c=new Uo({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+m);let w=S+d+o,y=S+m+a,C=bu(r,r.VERTEX_SHADER,w),R=bu(r,r.FRAGMENT_SHADER,y);r.attachShader(v,C),r.attachShader(v,R),t.index0AttributeName!==void 0?r.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function T(P){if(i.debug.checkShaderErrors){let B=r.getProgramInfoLog(v)||"",H=r.getShaderInfoLog(C)||"",W=r.getShaderInfoLog(R)||"",U=B.trim(),O=H.trim(),D=W.trim(),Z=!0,j=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,v,C,R);else{let he=wu(r,C,"vertex"),Y=wu(r,R,"fragment");We("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
Program Info Log: `+U+`
`+he+`
`+Y)}else U!==""?He("WebGLProgram: Program Info Log:",U):(O===""||D==="")&&(j=!1);j&&(P.diagnostics={runnable:Z,programLog:U,vertexShader:{log:O,prefix:d},fragmentShader:{log:D,prefix:m}})}r.deleteShader(C),r.deleteShader(R),x=new Ar(r,v),E=Lg(r,v)}let x;this.getUniforms=function(){return x===void 0&&T(this),x};let E;this.getAttributes=function(){return E===void 0&&T(this),E};let k=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return k===!1&&(k=r.getProgramParameter(v,Sg)),k},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=wg++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=C,this.fragmentShader=R,this}var Jg=0,Cc=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){let t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){let t=this.materialCache.get(e);for(let n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){let t=this.materialCache,n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){let t=this.shaderCache,n=t.get(e);return n===void 0&&(n=new Pc(e),t.set(e,n)),n}},Pc=class{constructor(e){this.id=Jg++,this.code=e,this.usedTimes=0}};function $g(i,e,t,n,r,s){let o=new Xr,a=new Cc,c=new Set,l=[],h=new Map,f=n.logarithmicDepthBuffer,u=n.precision,p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return c.add(x),x===0?"uv":`uv${x}`}function v(x,E,k,P,B){let H=P.fog,W=B.geometry,U=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?P.environment:null,O=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,D=e.get(x.envMap||U,O),Z=D&&D.mapping===_s?D.image.height:null,j=p[x.type];x.precision!==null&&(u=n.getMaxPrecision(x.precision),u!==x.precision&&He("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));let he=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Y=he!==void 0?he.length:0,$=0;W.morphAttributes.position!==void 0&&($=1),W.morphAttributes.normal!==void 0&&($=2),W.morphAttributes.color!==void 0&&($=3);let ae,pe,Ae,V;if(j){let at=Bn[j];ae=at.vertexShader,pe=at.fragmentShader}else ae=x.vertexShader,pe=x.fragmentShader,a.update(x),Ae=a.getVertexShaderID(x),V=a.getFragmentShaderID(x);let Q=i.getRenderTarget(),le=i.state.buffers.depth.getReversed(),Te=B.isInstancedMesh===!0,Ie=B.isBatchedMesh===!0,me=!!x.map,Xe=!!x.matcap,Ge=!!D,te=!!x.aoMap,oe=!!x.lightMap,re=!!x.bumpMap,ye=!!x.normalMap,A=!!x.displacementMap,Oe=!!x.emissiveMap,we=!!x.metalnessMap,Ve=!!x.roughnessMap,F=x.anisotropy>0,b=x.clearcoat>0,_=x.dispersion>0,L=x.iridescence>0,G=x.sheen>0,ne=x.transmission>0,J=F&&!!x.anisotropyMap,fe=b&&!!x.clearcoatMap,ie=b&&!!x.clearcoatNormalMap,Ee=b&&!!x.clearcoatRoughnessMap,Be=L&&!!x.iridescenceMap,ce=L&&!!x.iridescenceThicknessMap,_e=G&&!!x.sheenColorMap,De=G&&!!x.sheenRoughnessMap,Ne=!!x.specularMap,Re=!!x.specularColorMap,tt=!!x.specularIntensityMap,N=ne&&!!x.transmissionMap,ve=ne&&!!x.thicknessMap,xe=!!x.gradientMap,Pe=!!x.alphaMap,ge=x.alphaTest>0,ee=!!x.alphaHash,Le=!!x.extensions,Ye=wn;x.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(Ye=i.toneMapping);let pt={shaderID:j,shaderType:x.type,shaderName:x.name,vertexShader:ae,fragmentShader:pe,defines:x.defines,customVertexShaderID:Ae,customFragmentShaderID:V,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:Ie,batchingColor:Ie&&B._colorsTexture!==null,instancing:Te,instancingColor:Te&&B.instanceColor!==null,instancingMorph:Te&&B.morphTexture!==null,outputColorSpace:Q===null?i.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:Ii,alphaToCoverage:!!x.alphaToCoverage,map:me,matcap:Xe,envMap:Ge,envMapMode:Ge&&D.mapping,envMapCubeUVHeight:Z,aoMap:te,lightMap:oe,bumpMap:re,normalMap:ye,displacementMap:A,emissiveMap:Oe,normalMapObjectSpace:ye&&x.normalMapType===Yh,normalMapTangentSpace:ye&&x.normalMapType===cc,metalnessMap:we,roughnessMap:Ve,anisotropy:F,anisotropyMap:J,clearcoat:b,clearcoatMap:fe,clearcoatNormalMap:ie,clearcoatRoughnessMap:Ee,dispersion:_,iridescence:L,iridescenceMap:Be,iridescenceThicknessMap:ce,sheen:G,sheenColorMap:_e,sheenRoughnessMap:De,specularMap:Ne,specularColorMap:Re,specularIntensityMap:tt,transmission:ne,transmissionMap:N,thicknessMap:ve,gradientMap:xe,opaque:x.transparent===!1&&x.blending===Ci&&x.alphaToCoverage===!1,alphaMap:Pe,alphaTest:ge,alphaHash:ee,combine:x.combine,mapUv:me&&g(x.map.channel),aoMapUv:te&&g(x.aoMap.channel),lightMapUv:oe&&g(x.lightMap.channel),bumpMapUv:re&&g(x.bumpMap.channel),normalMapUv:ye&&g(x.normalMap.channel),displacementMapUv:A&&g(x.displacementMap.channel),emissiveMapUv:Oe&&g(x.emissiveMap.channel),metalnessMapUv:we&&g(x.metalnessMap.channel),roughnessMapUv:Ve&&g(x.roughnessMap.channel),anisotropyMapUv:J&&g(x.anisotropyMap.channel),clearcoatMapUv:fe&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:ie&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ee&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Be&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:ce&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:_e&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:De&&g(x.sheenRoughnessMap.channel),specularMapUv:Ne&&g(x.specularMap.channel),specularColorMapUv:Re&&g(x.specularColorMap.channel),specularIntensityMapUv:tt&&g(x.specularIntensityMap.channel),transmissionMapUv:N&&g(x.transmissionMap.channel),thicknessMapUv:ve&&g(x.thicknessMap.channel),alphaMapUv:Pe&&g(x.alphaMap.channel),vertexTangents:!!W.attributes.tangent&&(ye||F),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!W.attributes.uv&&(me||Pe),fog:!!H,useFog:x.fog===!0,fogExp2:!!H&&H.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||W.attributes.normal===void 0&&ye===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:le,skinning:B.isSkinnedMesh===!0,morphTargets:W.morphAttributes.position!==void 0,morphNormals:W.morphAttributes.normal!==void 0,morphColors:W.morphAttributes.color!==void 0,morphTargetsCount:Y,morphTextureStride:$,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&k.length>0,shadowMapType:i.shadowMap.type,toneMapping:Ye,decodeVideoTexture:me&&x.map.isVideoTexture===!0&&rt.getTransfer(x.map.colorSpace)===ot,decodeVideoTextureEmissive:Oe&&x.emissiveMap.isVideoTexture===!0&&rt.getTransfer(x.emissiveMap.colorSpace)===ot,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Qt,flipSided:x.side===Kt,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:Le&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Le&&x.extensions.multiDraw===!0||Ie)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return pt.vertexUv1s=c.has(1),pt.vertexUv2s=c.has(2),pt.vertexUv3s=c.has(3),c.clear(),pt}function d(x){let E=[];if(x.shaderID?E.push(x.shaderID):(E.push(x.customVertexShaderID),E.push(x.customFragmentShaderID)),x.defines!==void 0)for(let k in x.defines)E.push(k),E.push(x.defines[k]);return x.isRawShaderMaterial===!1&&(m(E,x),S(E,x),E.push(i.outputColorSpace)),E.push(x.customProgramCacheKey),E.join()}function m(x,E){x.push(E.precision),x.push(E.outputColorSpace),x.push(E.envMapMode),x.push(E.envMapCubeUVHeight),x.push(E.mapUv),x.push(E.alphaMapUv),x.push(E.lightMapUv),x.push(E.aoMapUv),x.push(E.bumpMapUv),x.push(E.normalMapUv),x.push(E.displacementMapUv),x.push(E.emissiveMapUv),x.push(E.metalnessMapUv),x.push(E.roughnessMapUv),x.push(E.anisotropyMapUv),x.push(E.clearcoatMapUv),x.push(E.clearcoatNormalMapUv),x.push(E.clearcoatRoughnessMapUv),x.push(E.iridescenceMapUv),x.push(E.iridescenceThicknessMapUv),x.push(E.sheenColorMapUv),x.push(E.sheenRoughnessMapUv),x.push(E.specularMapUv),x.push(E.specularColorMapUv),x.push(E.specularIntensityMapUv),x.push(E.transmissionMapUv),x.push(E.thicknessMapUv),x.push(E.combine),x.push(E.fogExp2),x.push(E.sizeAttenuation),x.push(E.morphTargetsCount),x.push(E.morphAttributeCount),x.push(E.numDirLights),x.push(E.numPointLights),x.push(E.numSpotLights),x.push(E.numSpotLightMaps),x.push(E.numHemiLights),x.push(E.numRectAreaLights),x.push(E.numDirLightShadows),x.push(E.numPointLightShadows),x.push(E.numSpotLightShadows),x.push(E.numSpotLightShadowsWithMaps),x.push(E.numLightProbes),x.push(E.shadowMapType),x.push(E.toneMapping),x.push(E.numClippingPlanes),x.push(E.numClipIntersection),x.push(E.depthPacking)}function S(x,E){o.disableAll(),E.instancing&&o.enable(0),E.instancingColor&&o.enable(1),E.instancingMorph&&o.enable(2),E.matcap&&o.enable(3),E.envMap&&o.enable(4),E.normalMapObjectSpace&&o.enable(5),E.normalMapTangentSpace&&o.enable(6),E.clearcoat&&o.enable(7),E.iridescence&&o.enable(8),E.alphaTest&&o.enable(9),E.vertexColors&&o.enable(10),E.vertexAlphas&&o.enable(11),E.vertexUv1s&&o.enable(12),E.vertexUv2s&&o.enable(13),E.vertexUv3s&&o.enable(14),E.vertexTangents&&o.enable(15),E.anisotropy&&o.enable(16),E.alphaHash&&o.enable(17),E.batching&&o.enable(18),E.dispersion&&o.enable(19),E.batchingColor&&o.enable(20),E.gradientMap&&o.enable(21),x.push(o.mask),o.disableAll(),E.fog&&o.enable(0),E.useFog&&o.enable(1),E.flatShading&&o.enable(2),E.logarithmicDepthBuffer&&o.enable(3),E.reversedDepthBuffer&&o.enable(4),E.skinning&&o.enable(5),E.morphTargets&&o.enable(6),E.morphNormals&&o.enable(7),E.morphColors&&o.enable(8),E.premultipliedAlpha&&o.enable(9),E.shadowMapEnabled&&o.enable(10),E.doubleSided&&o.enable(11),E.flipSided&&o.enable(12),E.useDepthPacking&&o.enable(13),E.dithering&&o.enable(14),E.transmission&&o.enable(15),E.sheen&&o.enable(16),E.opaque&&o.enable(17),E.pointsUvs&&o.enable(18),E.decodeVideoTexture&&o.enable(19),E.decodeVideoTextureEmissive&&o.enable(20),E.alphaToCoverage&&o.enable(21),x.push(o.mask)}function w(x){let E=p[x.type],k;if(E){let P=Bn[E];k=cu.clone(P.uniforms)}else k=x.uniforms;return k}function y(x,E){let k=h.get(E);return k!==void 0?++k.usedTimes:(k=new Zg(i,E,x,r),l.push(k),h.set(E,k)),k}function C(x){if(--x.usedTimes===0){let E=l.indexOf(x);l[E]=l[l.length-1],l.pop(),h.delete(x.cacheKey),x.destroy()}}function R(x){a.remove(x)}function T(){a.dispose()}return{getParameters:v,getProgramCacheKey:d,getUniforms:w,acquireProgram:y,releaseProgram:C,releaseShaderCache:R,programs:l,dispose:T}}function Kg(){let i=new WeakMap;function e(o){return i.has(o)}function t(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function r(o,a,c){i.get(o)[a]=c}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function jg(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function Cu(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Pu(){let i=[],e=0,t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function o(u){let p=0;return u.isInstancedMesh&&(p+=2),u.isSkinnedMesh&&(p+=1),p}function a(u,p,g,v,d,m){let S=i[e];return S===void 0?(S={id:u.id,object:u,geometry:p,material:g,materialVariant:o(u),groupOrder:v,renderOrder:u.renderOrder,z:d,group:m},i[e]=S):(S.id=u.id,S.object=u,S.geometry=p,S.material=g,S.materialVariant=o(u),S.groupOrder=v,S.renderOrder=u.renderOrder,S.z=d,S.group=m),e++,S}function c(u,p,g,v,d,m){let S=a(u,p,g,v,d,m);g.transmission>0?n.push(S):g.transparent===!0?r.push(S):t.push(S)}function l(u,p,g,v,d,m){let S=a(u,p,g,v,d,m);g.transmission>0?n.unshift(S):g.transparent===!0?r.unshift(S):t.unshift(S)}function h(u,p){t.length>1&&t.sort(u||jg),n.length>1&&n.sort(p||Cu),r.length>1&&r.sort(p||Cu)}function f(){for(let u=e,p=i.length;u<p;u++){let g=i[u];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:c,unshift:l,finish:f,sort:h}}function Qg(){let i=new WeakMap;function e(n,r){let s=i.get(n),o;return s===void 0?(o=new Pu,i.set(n,[o])):r>=s.length?(o=new Pu,s.push(o)):o=s[r],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function e_(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new I,color:new it};break;case"SpotLight":t={position:new I,direction:new I,color:new it,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new I,color:new it,distance:0,decay:0};break;case"HemisphereLight":t={direction:new I,skyColor:new it,groundColor:new it};break;case"RectAreaLight":t={color:new it,position:new I,halfWidth:new I,halfHeight:new I};break}return i[e.id]=t,t}}}function t_(){let i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ue};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ue};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ue,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}var n_=0;function i_(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function r_(i){let e=new e_,t=t_(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new I);let r=new I,s=new ht,o=new ht;function a(l){let h=0,f=0,u=0;for(let E=0;E<9;E++)n.probe[E].set(0,0,0);let p=0,g=0,v=0,d=0,m=0,S=0,w=0,y=0,C=0,R=0,T=0;l.sort(i_);for(let E=0,k=l.length;E<k;E++){let P=l[E],B=P.color,H=P.intensity,W=P.distance,U=null;if(P.shadow&&P.shadow.map&&(P.shadow.map.texture.format===Bi?U=P.shadow.map.texture:U=P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)h+=B.r*H,f+=B.g*H,u+=B.b*H;else if(P.isLightProbe){for(let O=0;O<9;O++)n.probe[O].addScaledVector(P.sh.coefficients[O],H);T++}else if(P.isDirectionalLight){let O=e.get(P);if(O.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){let D=P.shadow,Z=t.get(P);Z.shadowIntensity=D.intensity,Z.shadowBias=D.bias,Z.shadowNormalBias=D.normalBias,Z.shadowRadius=D.radius,Z.shadowMapSize=D.mapSize,n.directionalShadow[p]=Z,n.directionalShadowMap[p]=U,n.directionalShadowMatrix[p]=P.shadow.matrix,S++}n.directional[p]=O,p++}else if(P.isSpotLight){let O=e.get(P);O.position.setFromMatrixPosition(P.matrixWorld),O.color.copy(B).multiplyScalar(H),O.distance=W,O.coneCos=Math.cos(P.angle),O.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),O.decay=P.decay,n.spot[v]=O;let D=P.shadow;if(P.map&&(n.spotLightMap[C]=P.map,C++,D.updateMatrices(P),P.castShadow&&R++),n.spotLightMatrix[v]=D.matrix,P.castShadow){let Z=t.get(P);Z.shadowIntensity=D.intensity,Z.shadowBias=D.bias,Z.shadowNormalBias=D.normalBias,Z.shadowRadius=D.radius,Z.shadowMapSize=D.mapSize,n.spotShadow[v]=Z,n.spotShadowMap[v]=U,y++}v++}else if(P.isRectAreaLight){let O=e.get(P);O.color.copy(B).multiplyScalar(H),O.halfWidth.set(P.width*.5,0,0),O.halfHeight.set(0,P.height*.5,0),n.rectArea[d]=O,d++}else if(P.isPointLight){let O=e.get(P);if(O.color.copy(P.color).multiplyScalar(P.intensity),O.distance=P.distance,O.decay=P.decay,P.castShadow){let D=P.shadow,Z=t.get(P);Z.shadowIntensity=D.intensity,Z.shadowBias=D.bias,Z.shadowNormalBias=D.normalBias,Z.shadowRadius=D.radius,Z.shadowMapSize=D.mapSize,Z.shadowCameraNear=D.camera.near,Z.shadowCameraFar=D.camera.far,n.pointShadow[g]=Z,n.pointShadowMap[g]=U,n.pointShadowMatrix[g]=P.shadow.matrix,w++}n.point[g]=O,g++}else if(P.isHemisphereLight){let O=e.get(P);O.skyColor.copy(P.color).multiplyScalar(H),O.groundColor.copy(P.groundColor).multiplyScalar(H),n.hemi[m]=O,m++}}d>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=Me.LTC_FLOAT_1,n.rectAreaLTC2=Me.LTC_FLOAT_2):(n.rectAreaLTC1=Me.LTC_HALF_1,n.rectAreaLTC2=Me.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=f,n.ambient[2]=u;let x=n.hash;(x.directionalLength!==p||x.pointLength!==g||x.spotLength!==v||x.rectAreaLength!==d||x.hemiLength!==m||x.numDirectionalShadows!==S||x.numPointShadows!==w||x.numSpotShadows!==y||x.numSpotMaps!==C||x.numLightProbes!==T)&&(n.directional.length=p,n.spot.length=v,n.rectArea.length=d,n.point.length=g,n.hemi.length=m,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.pointShadow.length=w,n.pointShadowMap.length=w,n.spotShadow.length=y,n.spotShadowMap.length=y,n.directionalShadowMatrix.length=S,n.pointShadowMatrix.length=w,n.spotLightMatrix.length=y+C-R,n.spotLightMap.length=C,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=T,x.directionalLength=p,x.pointLength=g,x.spotLength=v,x.rectAreaLength=d,x.hemiLength=m,x.numDirectionalShadows=S,x.numPointShadows=w,x.numSpotShadows=y,x.numSpotMaps=C,x.numLightProbes=T,n.version=n_++)}function c(l,h){let f=0,u=0,p=0,g=0,v=0,d=h.matrixWorldInverse;for(let m=0,S=l.length;m<S;m++){let w=l[m];if(w.isDirectionalLight){let y=n.directional[f];y.direction.setFromMatrixPosition(w.matrixWorld),r.setFromMatrixPosition(w.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(d),f++}else if(w.isSpotLight){let y=n.spot[p];y.position.setFromMatrixPosition(w.matrixWorld),y.position.applyMatrix4(d),y.direction.setFromMatrixPosition(w.matrixWorld),r.setFromMatrixPosition(w.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(d),p++}else if(w.isRectAreaLight){let y=n.rectArea[g];y.position.setFromMatrixPosition(w.matrixWorld),y.position.applyMatrix4(d),o.identity(),s.copy(w.matrixWorld),s.premultiply(d),o.extractRotation(s),y.halfWidth.set(w.width*.5,0,0),y.halfHeight.set(0,w.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),g++}else if(w.isPointLight){let y=n.point[u];y.position.setFromMatrixPosition(w.matrixWorld),y.position.applyMatrix4(d),u++}else if(w.isHemisphereLight){let y=n.hemi[v];y.direction.setFromMatrixPosition(w.matrixWorld),y.direction.transformDirection(d),v++}}}return{setup:a,setupView:c,state:n}}function Iu(i){let e=new r_(i),t=[],n=[];function r(h){l.camera=h,t.length=0,n.length=0}function s(h){t.push(h)}function o(h){n.push(h)}function a(){e.setup(t)}function c(h){e.setupView(t,h)}let l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:l,setupLights:a,setupLightsView:c,pushLight:s,pushShadow:o}}function s_(i){let e=new WeakMap;function t(r,s=0){let o=e.get(r),a;return o===void 0?(a=new Iu(i),e.set(r,[a])):s>=o.length?(a=new Iu(i),o.push(a)):a=o[s],a}function n(){e=new WeakMap}return{get:t,dispose:n}}var o_=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,l_=[new I(1,0,0),new I(-1,0,0),new I(0,1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1)],c_=[new I(0,-1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1),new I(0,-1,0),new I(0,-1,0)],Du=new ht,ws=new I,Sc=new I;function h_(i,e,t){let n=new mr,r=new ue,s=new ue,o=new bt,a=new Fo,c=new Oo,l={},h=t.maxTextureSize,f={[Jn]:Kt,[Kt]:Jn,[Qt]:Qt},u=new dn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ue},radius:{value:4}},vertexShader:o_,fragmentShader:a_}),p=u.clone();p.defines.HORIZONTAL_PASS=1;let g=new zt;g.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let v=new Rt(g,u),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ms;let m=this.type;this.render=function(R,T,x){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||R.length===0)return;this.type===$o&&(He("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ms);let E=i.getRenderTarget(),k=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),B=i.state;B.setBlending(Un),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);let H=m!==this.type;H&&T.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(U=>U.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,U=R.length;W<U;W++){let O=R[W],D=O.shadow;if(D===void 0){He("WebGLShadowMap:",O,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);let Z=D.getFrameExtents();r.multiply(Z),s.copy(D.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/Z.x),r.x=s.x*Z.x,D.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/Z.y),r.y=s.y*Z.y,D.mapSize.y=s.y));let j=i.state.buffers.depth.getReversed();if(D.camera._reversedDepth=j,D.map===null||H===!0){if(D.map!==null&&(D.map.depthTexture!==null&&(D.map.depthTexture.dispose(),D.map.depthTexture=null),D.map.dispose()),this.type===br){if(O.isPointLight){He("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}D.map=new hn(r.x,r.y,{format:Bi,type:Fn,minFilter:Ot,magFilter:Ot,generateMipmaps:!1}),D.map.texture.name=O.name+".shadowMap",D.map.depthTexture=new li(r.x,r.y,Tn),D.map.depthTexture.name=O.name+".shadowMapDepth",D.map.depthTexture.format=In,D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=Ut,D.map.depthTexture.magFilter=Ut}else O.isPointLight?(D.map=new Ga(r.x),D.map.depthTexture=new Ro(r.x,En)):(D.map=new hn(r.x,r.y),D.map.depthTexture=new li(r.x,r.y,En)),D.map.depthTexture.name=O.name+".shadowMap",D.map.depthTexture.format=In,this.type===ms?(D.map.depthTexture.compareFunction=j?za:Ba,D.map.depthTexture.minFilter=Ot,D.map.depthTexture.magFilter=Ot):(D.map.depthTexture.compareFunction=null,D.map.depthTexture.minFilter=Ut,D.map.depthTexture.magFilter=Ut);D.camera.updateProjectionMatrix()}let he=D.map.isWebGLCubeRenderTarget?6:1;for(let Y=0;Y<he;Y++){if(D.map.isWebGLCubeRenderTarget)i.setRenderTarget(D.map,Y),i.clear();else{Y===0&&(i.setRenderTarget(D.map),i.clear());let $=D.getViewport(Y);o.set(s.x*$.x,s.y*$.y,s.x*$.z,s.y*$.w),B.viewport(o)}if(O.isPointLight){let $=D.camera,ae=D.matrix,pe=O.distance||$.far;pe!==$.far&&($.far=pe,$.updateProjectionMatrix()),ws.setFromMatrixPosition(O.matrixWorld),$.position.copy(ws),Sc.copy($.position),Sc.add(l_[Y]),$.up.copy(c_[Y]),$.lookAt(Sc),$.updateMatrixWorld(),ae.makeTranslation(-ws.x,-ws.y,-ws.z),Du.multiplyMatrices($.projectionMatrix,$.matrixWorldInverse),D._frustum.setFromProjectionMatrix(Du,$.coordinateSystem,$.reversedDepth)}else D.updateMatrices(O);n=D.getFrustum(),y(T,x,D.camera,O,this.type)}D.isPointLightShadow!==!0&&this.type===br&&S(D,x),D.needsUpdate=!1}m=this.type,d.needsUpdate=!1,i.setRenderTarget(E,k,P)};function S(R,T){let x=e.update(v);u.defines.VSM_SAMPLES!==R.blurSamples&&(u.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new hn(r.x,r.y,{format:Bi,type:Fn})),u.uniforms.shadow_pass.value=R.map.depthTexture,u.uniforms.resolution.value=R.mapSize,u.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(T,null,x,u,v,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(T,null,x,p,v,null)}function w(R,T,x,E){let k=null,P=x.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(P!==void 0)k=P;else if(k=x.isPointLight===!0?c:a,i.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0||T.alphaToCoverage===!0){let B=k.uuid,H=T.uuid,W=l[B];W===void 0&&(W={},l[B]=W);let U=W[H];U===void 0&&(U=k.clone(),W[H]=U,T.addEventListener("dispose",C)),k=U}if(k.visible=T.visible,k.wireframe=T.wireframe,E===br?k.side=T.shadowSide!==null?T.shadowSide:T.side:k.side=T.shadowSide!==null?T.shadowSide:f[T.side],k.alphaMap=T.alphaMap,k.alphaTest=T.alphaToCoverage===!0?.5:T.alphaTest,k.map=T.map,k.clipShadows=T.clipShadows,k.clippingPlanes=T.clippingPlanes,k.clipIntersection=T.clipIntersection,k.displacementMap=T.displacementMap,k.displacementScale=T.displacementScale,k.displacementBias=T.displacementBias,k.wireframeLinewidth=T.wireframeLinewidth,k.linewidth=T.linewidth,x.isPointLight===!0&&k.isMeshDistanceMaterial===!0){let B=i.properties.get(k);B.light=x}return k}function y(R,T,x,E,k){if(R.visible===!1)return;if(R.layers.test(T.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&k===br)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,R.matrixWorld);let H=e.update(R),W=R.material;if(Array.isArray(W)){let U=H.groups;for(let O=0,D=U.length;O<D;O++){let Z=U[O],j=W[Z.materialIndex];if(j&&j.visible){let he=w(R,j,E,k);R.onBeforeShadow(i,R,T,x,H,he,Z),i.renderBufferDirect(x,null,H,he,R,Z),R.onAfterShadow(i,R,T,x,H,he,Z)}}}else if(W.visible){let U=w(R,W,E,k);R.onBeforeShadow(i,R,T,x,H,U,null),i.renderBufferDirect(x,null,H,U,R,null),R.onAfterShadow(i,R,T,x,H,U,null)}}let B=R.children;for(let H=0,W=B.length;H<W;H++)y(B[H],T,x,E,k)}function C(R){R.target.removeEventListener("dispose",C);for(let x in l){let E=l[x],k=R.target.uuid;k in E&&(E[k].dispose(),delete E[k])}}}function u_(i,e){function t(){let N=!1,ve=new bt,xe=null,Pe=new bt(0,0,0,0);return{setMask:function(ge){xe!==ge&&!N&&(i.colorMask(ge,ge,ge,ge),xe=ge)},setLocked:function(ge){N=ge},setClear:function(ge,ee,Le,Ye,pt){pt===!0&&(ge*=Ye,ee*=Ye,Le*=Ye),ve.set(ge,ee,Le,Ye),Pe.equals(ve)===!1&&(i.clearColor(ge,ee,Le,Ye),Pe.copy(ve))},reset:function(){N=!1,xe=null,Pe.set(-1,0,0,0)}}}function n(){let N=!1,ve=!1,xe=null,Pe=null,ge=null;return{setReversed:function(ee){if(ve!==ee){let Le=e.get("EXT_clip_control");ee?Le.clipControlEXT(Le.LOWER_LEFT_EXT,Le.ZERO_TO_ONE_EXT):Le.clipControlEXT(Le.LOWER_LEFT_EXT,Le.NEGATIVE_ONE_TO_ONE_EXT),ve=ee;let Ye=ge;ge=null,this.setClear(Ye)}},getReversed:function(){return ve},setTest:function(ee){ee?Q(i.DEPTH_TEST):le(i.DEPTH_TEST)},setMask:function(ee){xe!==ee&&!N&&(i.depthMask(ee),xe=ee)},setFunc:function(ee){if(ve&&(ee=iu[ee]),Pe!==ee){switch(ee){case ho:i.depthFunc(i.NEVER);break;case uo:i.depthFunc(i.ALWAYS);break;case fo:i.depthFunc(i.LESS);break;case Pi:i.depthFunc(i.LEQUAL);break;case po:i.depthFunc(i.EQUAL);break;case mo:i.depthFunc(i.GEQUAL);break;case go:i.depthFunc(i.GREATER);break;case _o:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Pe=ee}},setLocked:function(ee){N=ee},setClear:function(ee){ge!==ee&&(ge=ee,ve&&(ee=1-ee),i.clearDepth(ee))},reset:function(){N=!1,xe=null,Pe=null,ge=null,ve=!1}}}function r(){let N=!1,ve=null,xe=null,Pe=null,ge=null,ee=null,Le=null,Ye=null,pt=null;return{setTest:function(at){N||(at?Q(i.STENCIL_TEST):le(i.STENCIL_TEST))},setMask:function(at){ve!==at&&!N&&(i.stencilMask(at),ve=at)},setFunc:function(at,kn,Vn){(xe!==at||Pe!==kn||ge!==Vn)&&(i.stencilFunc(at,kn,Vn),xe=at,Pe=kn,ge=Vn)},setOp:function(at,kn,Vn){(ee!==at||Le!==kn||Ye!==Vn)&&(i.stencilOp(at,kn,Vn),ee=at,Le=kn,Ye=Vn)},setLocked:function(at){N=at},setClear:function(at){pt!==at&&(i.clearStencil(at),pt=at)},reset:function(){N=!1,ve=null,xe=null,Pe=null,ge=null,ee=null,Le=null,Ye=null,pt=null}}}let s=new t,o=new n,a=new r,c=new WeakMap,l=new WeakMap,h={},f={},u=new WeakMap,p=[],g=null,v=!1,d=null,m=null,S=null,w=null,y=null,C=null,R=null,T=new it(0,0,0),x=0,E=!1,k=null,P=null,B=null,H=null,W=null,U=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),O=!1,D=0,Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(D=parseFloat(/^WebGL (\d)/.exec(Z)[1]),O=D>=1):Z.indexOf("OpenGL ES")!==-1&&(D=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),O=D>=2);let j=null,he={},Y=i.getParameter(i.SCISSOR_BOX),$=i.getParameter(i.VIEWPORT),ae=new bt().fromArray(Y),pe=new bt().fromArray($);function Ae(N,ve,xe,Pe){let ge=new Uint8Array(4),ee=i.createTexture();i.bindTexture(N,ee),i.texParameteri(N,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(N,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Le=0;Le<xe;Le++)N===i.TEXTURE_3D||N===i.TEXTURE_2D_ARRAY?i.texImage3D(ve,0,i.RGBA,1,1,Pe,0,i.RGBA,i.UNSIGNED_BYTE,ge):i.texImage2D(ve+Le,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ge);return ee}let V={};V[i.TEXTURE_2D]=Ae(i.TEXTURE_2D,i.TEXTURE_2D,1),V[i.TEXTURE_CUBE_MAP]=Ae(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),V[i.TEXTURE_2D_ARRAY]=Ae(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),V[i.TEXTURE_3D]=Ae(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Q(i.DEPTH_TEST),o.setFunc(Pi),re(!1),ye(Wl),Q(i.CULL_FACE),te(Un);function Q(N){h[N]!==!0&&(i.enable(N),h[N]=!0)}function le(N){h[N]!==!1&&(i.disable(N),h[N]=!1)}function Te(N,ve){return f[N]!==ve?(i.bindFramebuffer(N,ve),f[N]=ve,N===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=ve),N===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=ve),!0):!1}function Ie(N,ve){let xe=p,Pe=!1;if(N){xe=u.get(ve),xe===void 0&&(xe=[],u.set(ve,xe));let ge=N.textures;if(xe.length!==ge.length||xe[0]!==i.COLOR_ATTACHMENT0){for(let ee=0,Le=ge.length;ee<Le;ee++)xe[ee]=i.COLOR_ATTACHMENT0+ee;xe.length=ge.length,Pe=!0}}else xe[0]!==i.BACK&&(xe[0]=i.BACK,Pe=!0);Pe&&i.drawBuffers(xe)}function me(N){return g!==N?(i.useProgram(N),g=N,!0):!1}let Xe={[ai]:i.FUNC_ADD,[Th]:i.FUNC_SUBTRACT,[Ah]:i.FUNC_REVERSE_SUBTRACT};Xe[Rh]=i.MIN,Xe[Ch]=i.MAX;let Ge={[Ph]:i.ZERO,[Ih]:i.ONE,[Dh]:i.SRC_COLOR,[lo]:i.SRC_ALPHA,[Bh]:i.SRC_ALPHA_SATURATE,[Fh]:i.DST_COLOR,[Nh]:i.DST_ALPHA,[Lh]:i.ONE_MINUS_SRC_COLOR,[co]:i.ONE_MINUS_SRC_ALPHA,[Oh]:i.ONE_MINUS_DST_COLOR,[Uh]:i.ONE_MINUS_DST_ALPHA,[zh]:i.CONSTANT_COLOR,[kh]:i.ONE_MINUS_CONSTANT_COLOR,[Vh]:i.CONSTANT_ALPHA,[Hh]:i.ONE_MINUS_CONSTANT_ALPHA};function te(N,ve,xe,Pe,ge,ee,Le,Ye,pt,at){if(N===Un){v===!0&&(le(i.BLEND),v=!1);return}if(v===!1&&(Q(i.BLEND),v=!0),N!==Eh){if(N!==d||at!==E){if((m!==ai||y!==ai)&&(i.blendEquation(i.FUNC_ADD),m=ai,y=ai),at)switch(N){case Ci:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Xl:i.blendFunc(i.ONE,i.ONE);break;case ql:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Yl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:We("WebGLState: Invalid blending: ",N);break}else switch(N){case Ci:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Xl:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ql:We("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Yl:We("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:We("WebGLState: Invalid blending: ",N);break}S=null,w=null,C=null,R=null,T.set(0,0,0),x=0,d=N,E=at}return}ge=ge||ve,ee=ee||xe,Le=Le||Pe,(ve!==m||ge!==y)&&(i.blendEquationSeparate(Xe[ve],Xe[ge]),m=ve,y=ge),(xe!==S||Pe!==w||ee!==C||Le!==R)&&(i.blendFuncSeparate(Ge[xe],Ge[Pe],Ge[ee],Ge[Le]),S=xe,w=Pe,C=ee,R=Le),(Ye.equals(T)===!1||pt!==x)&&(i.blendColor(Ye.r,Ye.g,Ye.b,pt),T.copy(Ye),x=pt),d=N,E=!1}function oe(N,ve){N.side===Qt?le(i.CULL_FACE):Q(i.CULL_FACE);let xe=N.side===Kt;ve&&(xe=!xe),re(xe),N.blending===Ci&&N.transparent===!1?te(Un):te(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),s.setMask(N.colorWrite);let Pe=N.stencilWrite;a.setTest(Pe),Pe&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Oe(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?Q(i.SAMPLE_ALPHA_TO_COVERAGE):le(i.SAMPLE_ALPHA_TO_COVERAGE)}function re(N){k!==N&&(N?i.frontFace(i.CW):i.frontFace(i.CCW),k=N)}function ye(N){N!==Sh?(Q(i.CULL_FACE),N!==P&&(N===Wl?i.cullFace(i.BACK):N===wh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):le(i.CULL_FACE),P=N}function A(N){N!==B&&(O&&i.lineWidth(N),B=N)}function Oe(N,ve,xe){N?(Q(i.POLYGON_OFFSET_FILL),(H!==ve||W!==xe)&&(H=ve,W=xe,o.getReversed()&&(ve=-ve),i.polygonOffset(ve,xe))):le(i.POLYGON_OFFSET_FILL)}function we(N){N?Q(i.SCISSOR_TEST):le(i.SCISSOR_TEST)}function Ve(N){N===void 0&&(N=i.TEXTURE0+U-1),j!==N&&(i.activeTexture(N),j=N)}function F(N,ve,xe){xe===void 0&&(j===null?xe=i.TEXTURE0+U-1:xe=j);let Pe=he[xe];Pe===void 0&&(Pe={type:void 0,texture:void 0},he[xe]=Pe),(Pe.type!==N||Pe.texture!==ve)&&(j!==xe&&(i.activeTexture(xe),j=xe),i.bindTexture(N,ve||V[N]),Pe.type=N,Pe.texture=ve)}function b(){let N=he[j];N!==void 0&&N.type!==void 0&&(i.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function _(){try{i.compressedTexImage2D(...arguments)}catch(N){We("WebGLState:",N)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(N){We("WebGLState:",N)}}function G(){try{i.texSubImage2D(...arguments)}catch(N){We("WebGLState:",N)}}function ne(){try{i.texSubImage3D(...arguments)}catch(N){We("WebGLState:",N)}}function J(){try{i.compressedTexSubImage2D(...arguments)}catch(N){We("WebGLState:",N)}}function fe(){try{i.compressedTexSubImage3D(...arguments)}catch(N){We("WebGLState:",N)}}function ie(){try{i.texStorage2D(...arguments)}catch(N){We("WebGLState:",N)}}function Ee(){try{i.texStorage3D(...arguments)}catch(N){We("WebGLState:",N)}}function Be(){try{i.texImage2D(...arguments)}catch(N){We("WebGLState:",N)}}function ce(){try{i.texImage3D(...arguments)}catch(N){We("WebGLState:",N)}}function _e(N){ae.equals(N)===!1&&(i.scissor(N.x,N.y,N.z,N.w),ae.copy(N))}function De(N){pe.equals(N)===!1&&(i.viewport(N.x,N.y,N.z,N.w),pe.copy(N))}function Ne(N,ve){let xe=l.get(ve);xe===void 0&&(xe=new WeakMap,l.set(ve,xe));let Pe=xe.get(N);Pe===void 0&&(Pe=i.getUniformBlockIndex(ve,N.name),xe.set(N,Pe))}function Re(N,ve){let Pe=l.get(ve).get(N);c.get(ve)!==Pe&&(i.uniformBlockBinding(ve,Pe,N.__bindingPointIndex),c.set(ve,Pe))}function tt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},j=null,he={},f={},u=new WeakMap,p=[],g=null,v=!1,d=null,m=null,S=null,w=null,y=null,C=null,R=null,T=new it(0,0,0),x=0,E=!1,k=null,P=null,B=null,H=null,W=null,ae.set(0,0,i.canvas.width,i.canvas.height),pe.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:Q,disable:le,bindFramebuffer:Te,drawBuffers:Ie,useProgram:me,setBlending:te,setMaterial:oe,setFlipSided:re,setCullFace:ye,setLineWidth:A,setPolygonOffset:Oe,setScissorTest:we,activeTexture:Ve,bindTexture:F,unbindTexture:b,compressedTexImage2D:_,compressedTexImage3D:L,texImage2D:Be,texImage3D:ce,updateUBOMapping:Ne,uniformBlockBinding:Re,texStorage2D:ie,texStorage3D:Ee,texSubImage2D:G,texSubImage3D:ne,compressedTexSubImage2D:J,compressedTexSubImage3D:fe,scissor:_e,viewport:De,reset:tt}}function d_(i,e,t,n,r,s,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ue,h=new WeakMap,f,u=new WeakMap,p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(b,_){return p?new OffscreenCanvas(b,_):Hr("canvas")}function v(b,_,L){let G=1,ne=F(b);if((ne.width>L||ne.height>L)&&(G=L/Math.max(ne.width,ne.height)),G<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){let J=Math.floor(G*ne.width),fe=Math.floor(G*ne.height);f===void 0&&(f=g(J,fe));let ie=_?g(J,fe):f;return ie.width=J,ie.height=fe,ie.getContext("2d").drawImage(b,0,0,J,fe),He("WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+J+"x"+fe+")."),ie}else return"data"in b&&He("WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),b;return b}function d(b){return b.generateMipmaps}function m(b){i.generateMipmap(b)}function S(b){return b.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:b.isWebGL3DRenderTarget?i.TEXTURE_3D:b.isWebGLArrayRenderTarget||b.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function w(b,_,L,G,ne=!1){if(b!==null){if(i[b]!==void 0)return i[b];He("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let J=_;if(_===i.RED&&(L===i.FLOAT&&(J=i.R32F),L===i.HALF_FLOAT&&(J=i.R16F),L===i.UNSIGNED_BYTE&&(J=i.R8)),_===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(J=i.R8UI),L===i.UNSIGNED_SHORT&&(J=i.R16UI),L===i.UNSIGNED_INT&&(J=i.R32UI),L===i.BYTE&&(J=i.R8I),L===i.SHORT&&(J=i.R16I),L===i.INT&&(J=i.R32I)),_===i.RG&&(L===i.FLOAT&&(J=i.RG32F),L===i.HALF_FLOAT&&(J=i.RG16F),L===i.UNSIGNED_BYTE&&(J=i.RG8)),_===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(J=i.RG8UI),L===i.UNSIGNED_SHORT&&(J=i.RG16UI),L===i.UNSIGNED_INT&&(J=i.RG32UI),L===i.BYTE&&(J=i.RG8I),L===i.SHORT&&(J=i.RG16I),L===i.INT&&(J=i.RG32I)),_===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(J=i.RGB8UI),L===i.UNSIGNED_SHORT&&(J=i.RGB16UI),L===i.UNSIGNED_INT&&(J=i.RGB32UI),L===i.BYTE&&(J=i.RGB8I),L===i.SHORT&&(J=i.RGB16I),L===i.INT&&(J=i.RGB32I)),_===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),L===i.UNSIGNED_INT&&(J=i.RGBA32UI),L===i.BYTE&&(J=i.RGBA8I),L===i.SHORT&&(J=i.RGBA16I),L===i.INT&&(J=i.RGBA32I)),_===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(J=i.R11F_G11F_B10F)),_===i.RGBA){let fe=ne?Vr:rt.getTransfer(G);L===i.FLOAT&&(J=i.RGBA32F),L===i.HALF_FLOAT&&(J=i.RGBA16F),L===i.UNSIGNED_BYTE&&(J=fe===ot?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function y(b,_){let L;return b?_===null||_===En||_===wr?L=i.DEPTH24_STENCIL8:_===Tn?L=i.DEPTH32F_STENCIL8:_===Sr&&(L=i.DEPTH24_STENCIL8,He("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===En||_===wr?L=i.DEPTH_COMPONENT24:_===Tn?L=i.DEPTH_COMPONENT32F:_===Sr&&(L=i.DEPTH_COMPONENT16),L}function C(b,_){return d(b)===!0||b.isFramebufferTexture&&b.minFilter!==Ut&&b.minFilter!==Ot?Math.log2(Math.max(_.width,_.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?_.mipmaps.length:1}function R(b){let _=b.target;_.removeEventListener("dispose",R),x(_),_.isVideoTexture&&h.delete(_)}function T(b){let _=b.target;_.removeEventListener("dispose",T),k(_)}function x(b){let _=n.get(b);if(_.__webglInit===void 0)return;let L=b.source,G=u.get(L);if(G){let ne=G[_.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&E(b),Object.keys(G).length===0&&u.delete(L)}n.remove(b)}function E(b){let _=n.get(b);i.deleteTexture(_.__webglTexture);let L=b.source,G=u.get(L);delete G[_.__cacheKey],o.memory.textures--}function k(b){let _=n.get(b);if(b.depthTexture&&(b.depthTexture.dispose(),n.remove(b.depthTexture)),b.isWebGLCubeRenderTarget)for(let G=0;G<6;G++){if(Array.isArray(_.__webglFramebuffer[G]))for(let ne=0;ne<_.__webglFramebuffer[G].length;ne++)i.deleteFramebuffer(_.__webglFramebuffer[G][ne]);else i.deleteFramebuffer(_.__webglFramebuffer[G]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[G])}else{if(Array.isArray(_.__webglFramebuffer))for(let G=0;G<_.__webglFramebuffer.length;G++)i.deleteFramebuffer(_.__webglFramebuffer[G]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let G=0;G<_.__webglColorRenderbuffer.length;G++)_.__webglColorRenderbuffer[G]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[G]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let L=b.textures;for(let G=0,ne=L.length;G<ne;G++){let J=n.get(L[G]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),o.memory.textures--),n.remove(L[G])}n.remove(b)}let P=0;function B(){P=0}function H(){let b=P;return b>=r.maxTextures&&He("WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),P+=1,b}function W(b){let _=[];return _.push(b.wrapS),_.push(b.wrapT),_.push(b.wrapR||0),_.push(b.magFilter),_.push(b.minFilter),_.push(b.anisotropy),_.push(b.internalFormat),_.push(b.format),_.push(b.type),_.push(b.generateMipmaps),_.push(b.premultiplyAlpha),_.push(b.flipY),_.push(b.unpackAlignment),_.push(b.colorSpace),_.join()}function U(b,_){let L=n.get(b);if(b.isVideoTexture&&we(b),b.isRenderTargetTexture===!1&&b.isExternalTexture!==!0&&b.version>0&&L.__version!==b.version){let G=b.image;if(G===null)He("WebGLRenderer: Texture marked for update but no image data found.");else if(G.complete===!1)He("WebGLRenderer: Texture marked for update but image is incomplete");else{V(L,b,_);return}}else b.isExternalTexture&&(L.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+_)}function O(b,_){let L=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){V(L,b,_);return}else b.isExternalTexture&&(L.__webglTexture=b.sourceTexture?b.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+_)}function D(b,_){let L=n.get(b);if(b.isRenderTargetTexture===!1&&b.version>0&&L.__version!==b.version){V(L,b,_);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+_)}function Z(b,_){let L=n.get(b);if(b.isCubeDepthTexture!==!0&&b.version>0&&L.__version!==b.version){Q(L,b,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+_)}let j={[xo]:i.REPEAT,[Pn]:i.CLAMP_TO_EDGE,[vo]:i.MIRRORED_REPEAT},he={[Ut]:i.NEAREST,[Xh]:i.NEAREST_MIPMAP_NEAREST,[xs]:i.NEAREST_MIPMAP_LINEAR,[Ot]:i.LINEAR,[Qo]:i.LINEAR_MIPMAP_NEAREST,[_i]:i.LINEAR_MIPMAP_LINEAR},Y={[Zh]:i.NEVER,[Qh]:i.ALWAYS,[Jh]:i.LESS,[Ba]:i.LEQUAL,[$h]:i.EQUAL,[za]:i.GEQUAL,[Kh]:i.GREATER,[jh]:i.NOTEQUAL};function $(b,_){if(_.type===Tn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Ot||_.magFilter===Qo||_.magFilter===xs||_.magFilter===_i||_.minFilter===Ot||_.minFilter===Qo||_.minFilter===xs||_.minFilter===_i)&&He("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(b,i.TEXTURE_WRAP_S,j[_.wrapS]),i.texParameteri(b,i.TEXTURE_WRAP_T,j[_.wrapT]),(b===i.TEXTURE_3D||b===i.TEXTURE_2D_ARRAY)&&i.texParameteri(b,i.TEXTURE_WRAP_R,j[_.wrapR]),i.texParameteri(b,i.TEXTURE_MAG_FILTER,he[_.magFilter]),i.texParameteri(b,i.TEXTURE_MIN_FILTER,he[_.minFilter]),_.compareFunction&&(i.texParameteri(b,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(b,i.TEXTURE_COMPARE_FUNC,Y[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ut||_.minFilter!==xs&&_.minFilter!==_i||_.type===Tn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(b,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ae(b,_){let L=!1;b.__webglInit===void 0&&(b.__webglInit=!0,_.addEventListener("dispose",R));let G=_.source,ne=u.get(G);ne===void 0&&(ne={},u.set(G,ne));let J=W(_);if(J!==b.__cacheKey){ne[J]===void 0&&(ne[J]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,L=!0),ne[J].usedTimes++;let fe=ne[b.__cacheKey];fe!==void 0&&(ne[b.__cacheKey].usedTimes--,fe.usedTimes===0&&E(_)),b.__cacheKey=J,b.__webglTexture=ne[J].texture}return L}function pe(b,_,L){return Math.floor(Math.floor(b/L)/_)}function Ae(b,_,L,G){let J=b.updateRanges;if(J.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,L,G,_.data);else{J.sort((ce,_e)=>ce.start-_e.start);let fe=0;for(let ce=1;ce<J.length;ce++){let _e=J[fe],De=J[ce],Ne=_e.start+_e.count,Re=pe(De.start,_.width,4),tt=pe(_e.start,_.width,4);De.start<=Ne+1&&Re===tt&&pe(De.start+De.count-1,_.width,4)===Re?_e.count=Math.max(_e.count,De.start+De.count-_e.start):(++fe,J[fe]=De)}J.length=fe+1;let ie=i.getParameter(i.UNPACK_ROW_LENGTH),Ee=i.getParameter(i.UNPACK_SKIP_PIXELS),Be=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ce=0,_e=J.length;ce<_e;ce++){let De=J[ce],Ne=Math.floor(De.start/4),Re=Math.ceil(De.count/4),tt=Ne%_.width,N=Math.floor(Ne/_.width),ve=Re,xe=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,tt),i.pixelStorei(i.UNPACK_SKIP_ROWS,N),t.texSubImage2D(i.TEXTURE_2D,0,tt,N,ve,xe,L,G,_.data)}b.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ie),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ee),i.pixelStorei(i.UNPACK_SKIP_ROWS,Be)}}function V(b,_,L){let G=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(G=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(G=i.TEXTURE_3D);let ne=ae(b,_),J=_.source;t.bindTexture(G,b.__webglTexture,i.TEXTURE0+L);let fe=n.get(J);if(J.version!==fe.__version||ne===!0){t.activeTexture(i.TEXTURE0+L);let ie=rt.getPrimaries(rt.workingColorSpace),Ee=_.colorSpace===Kn?null:rt.getPrimaries(_.colorSpace),Be=_.colorSpace===Kn||ie===Ee?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Be);let ce=v(_.image,!1,r.maxTextureSize);ce=Ve(_,ce);let _e=s.convert(_.format,_.colorSpace),De=s.convert(_.type),Ne=w(_.internalFormat,_e,De,_.colorSpace,_.isVideoTexture);$(G,_);let Re,tt=_.mipmaps,N=_.isVideoTexture!==!0,ve=fe.__version===void 0||ne===!0,xe=J.dataReady,Pe=C(_,ce);if(_.isDepthTexture)Ne=y(_.format===xi,_.type),ve&&(N?t.texStorage2D(i.TEXTURE_2D,1,Ne,ce.width,ce.height):t.texImage2D(i.TEXTURE_2D,0,Ne,ce.width,ce.height,0,_e,De,null));else if(_.isDataTexture)if(tt.length>0){N&&ve&&t.texStorage2D(i.TEXTURE_2D,Pe,Ne,tt[0].width,tt[0].height);for(let ge=0,ee=tt.length;ge<ee;ge++)Re=tt[ge],N?xe&&t.texSubImage2D(i.TEXTURE_2D,ge,0,0,Re.width,Re.height,_e,De,Re.data):t.texImage2D(i.TEXTURE_2D,ge,Ne,Re.width,Re.height,0,_e,De,Re.data);_.generateMipmaps=!1}else N?(ve&&t.texStorage2D(i.TEXTURE_2D,Pe,Ne,ce.width,ce.height),xe&&Ae(_,ce,_e,De)):t.texImage2D(i.TEXTURE_2D,0,Ne,ce.width,ce.height,0,_e,De,ce.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){N&&ve&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Pe,Ne,tt[0].width,tt[0].height,ce.depth);for(let ge=0,ee=tt.length;ge<ee;ge++)if(Re=tt[ge],_.format!==mn)if(_e!==null)if(N){if(xe)if(_.layerUpdates.size>0){let Le=_c(Re.width,Re.height,_.format,_.type);for(let Ye of _.layerUpdates){let pt=Re.data.subarray(Ye*Le/Re.data.BYTES_PER_ELEMENT,(Ye+1)*Le/Re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ge,0,0,Ye,Re.width,Re.height,1,_e,pt)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ge,0,0,0,Re.width,Re.height,ce.depth,_e,Re.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ge,Ne,Re.width,Re.height,ce.depth,0,Re.data,0,0);else He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else N?xe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ge,0,0,0,Re.width,Re.height,ce.depth,_e,De,Re.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ge,Ne,Re.width,Re.height,ce.depth,0,_e,De,Re.data)}else{N&&ve&&t.texStorage2D(i.TEXTURE_2D,Pe,Ne,tt[0].width,tt[0].height);for(let ge=0,ee=tt.length;ge<ee;ge++)Re=tt[ge],_.format!==mn?_e!==null?N?xe&&t.compressedTexSubImage2D(i.TEXTURE_2D,ge,0,0,Re.width,Re.height,_e,Re.data):t.compressedTexImage2D(i.TEXTURE_2D,ge,Ne,Re.width,Re.height,0,Re.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):N?xe&&t.texSubImage2D(i.TEXTURE_2D,ge,0,0,Re.width,Re.height,_e,De,Re.data):t.texImage2D(i.TEXTURE_2D,ge,Ne,Re.width,Re.height,0,_e,De,Re.data)}else if(_.isDataArrayTexture)if(N){if(ve&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Pe,Ne,ce.width,ce.height,ce.depth),xe)if(_.layerUpdates.size>0){let ge=_c(ce.width,ce.height,_.format,_.type);for(let ee of _.layerUpdates){let Le=ce.data.subarray(ee*ge/ce.data.BYTES_PER_ELEMENT,(ee+1)*ge/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ee,ce.width,ce.height,1,_e,De,Le)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,_e,De,ce.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ne,ce.width,ce.height,ce.depth,0,_e,De,ce.data);else if(_.isData3DTexture)N?(ve&&t.texStorage3D(i.TEXTURE_3D,Pe,Ne,ce.width,ce.height,ce.depth),xe&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,_e,De,ce.data)):t.texImage3D(i.TEXTURE_3D,0,Ne,ce.width,ce.height,ce.depth,0,_e,De,ce.data);else if(_.isFramebufferTexture){if(ve)if(N)t.texStorage2D(i.TEXTURE_2D,Pe,Ne,ce.width,ce.height);else{let ge=ce.width,ee=ce.height;for(let Le=0;Le<Pe;Le++)t.texImage2D(i.TEXTURE_2D,Le,Ne,ge,ee,0,_e,De,null),ge>>=1,ee>>=1}}else if(tt.length>0){if(N&&ve){let ge=F(tt[0]);t.texStorage2D(i.TEXTURE_2D,Pe,Ne,ge.width,ge.height)}for(let ge=0,ee=tt.length;ge<ee;ge++)Re=tt[ge],N?xe&&t.texSubImage2D(i.TEXTURE_2D,ge,0,0,_e,De,Re):t.texImage2D(i.TEXTURE_2D,ge,Ne,_e,De,Re);_.generateMipmaps=!1}else if(N){if(ve){let ge=F(ce);t.texStorage2D(i.TEXTURE_2D,Pe,Ne,ge.width,ge.height)}xe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,_e,De,ce)}else t.texImage2D(i.TEXTURE_2D,0,Ne,_e,De,ce);d(_)&&m(G),fe.__version=J.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function Q(b,_,L){if(_.image.length!==6)return;let G=ae(b,_),ne=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,b.__webglTexture,i.TEXTURE0+L);let J=n.get(ne);if(ne.version!==J.__version||G===!0){t.activeTexture(i.TEXTURE0+L);let fe=rt.getPrimaries(rt.workingColorSpace),ie=_.colorSpace===Kn?null:rt.getPrimaries(_.colorSpace),Ee=_.colorSpace===Kn||fe===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);let Be=_.isCompressedTexture||_.image[0].isCompressedTexture,ce=_.image[0]&&_.image[0].isDataTexture,_e=[];for(let ee=0;ee<6;ee++)!Be&&!ce?_e[ee]=v(_.image[ee],!0,r.maxCubemapSize):_e[ee]=ce?_.image[ee].image:_.image[ee],_e[ee]=Ve(_,_e[ee]);let De=_e[0],Ne=s.convert(_.format,_.colorSpace),Re=s.convert(_.type),tt=w(_.internalFormat,Ne,Re,_.colorSpace),N=_.isVideoTexture!==!0,ve=J.__version===void 0||G===!0,xe=ne.dataReady,Pe=C(_,De);$(i.TEXTURE_CUBE_MAP,_);let ge;if(Be){N&&ve&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Pe,tt,De.width,De.height);for(let ee=0;ee<6;ee++){ge=_e[ee].mipmaps;for(let Le=0;Le<ge.length;Le++){let Ye=ge[Le];_.format!==mn?Ne!==null?N?xe&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le,0,0,Ye.width,Ye.height,Ne,Ye.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le,tt,Ye.width,Ye.height,0,Ye.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?xe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le,0,0,Ye.width,Ye.height,Ne,Re,Ye.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le,tt,Ye.width,Ye.height,0,Ne,Re,Ye.data)}}}else{if(ge=_.mipmaps,N&&ve){ge.length>0&&Pe++;let ee=F(_e[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Pe,tt,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(ce){N?xe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,_e[ee].width,_e[ee].height,Ne,Re,_e[ee].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,tt,_e[ee].width,_e[ee].height,0,Ne,Re,_e[ee].data);for(let Le=0;Le<ge.length;Le++){let pt=ge[Le].image[ee].image;N?xe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le+1,0,0,pt.width,pt.height,Ne,Re,pt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le+1,tt,pt.width,pt.height,0,Ne,Re,pt.data)}}else{N?xe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ne,Re,_e[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,tt,Ne,Re,_e[ee]);for(let Le=0;Le<ge.length;Le++){let Ye=ge[Le];N?xe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le+1,0,0,Ne,Re,Ye.image[ee]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Le+1,tt,Ne,Re,Ye.image[ee])}}}d(_)&&m(i.TEXTURE_CUBE_MAP),J.__version=ne.version,_.onUpdate&&_.onUpdate(_)}b.__version=_.version}function le(b,_,L,G,ne,J){let fe=s.convert(L.format,L.colorSpace),ie=s.convert(L.type),Ee=w(L.internalFormat,fe,ie,L.colorSpace),Be=n.get(_),ce=n.get(L);if(ce.__renderTarget=_,!Be.__hasExternalTextures){let _e=Math.max(1,_.width>>J),De=Math.max(1,_.height>>J);ne===i.TEXTURE_3D||ne===i.TEXTURE_2D_ARRAY?t.texImage3D(ne,J,Ee,_e,De,_.depth,0,fe,ie,null):t.texImage2D(ne,J,Ee,_e,De,0,fe,ie,null)}t.bindFramebuffer(i.FRAMEBUFFER,b),Oe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,G,ne,ce.__webglTexture,0,A(_)):(ne===i.TEXTURE_2D||ne>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,G,ne,ce.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Te(b,_,L){if(i.bindRenderbuffer(i.RENDERBUFFER,b),_.depthBuffer){let G=_.depthTexture,ne=G&&G.isDepthTexture?G.type:null,J=y(_.stencilBuffer,ne),fe=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Oe(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,A(_),J,_.width,_.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,A(_),J,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,J,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,fe,i.RENDERBUFFER,b)}else{let G=_.textures;for(let ne=0;ne<G.length;ne++){let J=G[ne],fe=s.convert(J.format,J.colorSpace),ie=s.convert(J.type),Ee=w(J.internalFormat,fe,ie,J.colorSpace);Oe(_)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,A(_),Ee,_.width,_.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,A(_),Ee,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Ee,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ie(b,_,L){let G=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,b),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let ne=n.get(_.depthTexture);if(ne.__renderTarget=_,(!ne.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),G){if(ne.__webglInit===void 0&&(ne.__webglInit=!0,_.depthTexture.addEventListener("dispose",R)),ne.__webglTexture===void 0){ne.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,ne.__webglTexture),$(i.TEXTURE_CUBE_MAP,_.depthTexture);let Be=s.convert(_.depthTexture.format),ce=s.convert(_.depthTexture.type),_e;_.depthTexture.format===In?_e=i.DEPTH_COMPONENT24:_.depthTexture.format===xi&&(_e=i.DEPTH24_STENCIL8);for(let De=0;De<6;De++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+De,0,_e,_.width,_.height,0,Be,ce,null)}}else U(_.depthTexture,0);let J=ne.__webglTexture,fe=A(_),ie=G?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,Ee=_.depthTexture.format===xi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===In)Oe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Ee,ie,J,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,Ee,ie,J,0);else if(_.depthTexture.format===xi)Oe(_)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Ee,ie,J,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,Ee,ie,J,0);else throw new Error("Unknown depthTexture format")}function me(b){let _=n.get(b),L=b.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==b.depthTexture){let G=b.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),G){let ne=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,G.removeEventListener("dispose",ne)};G.addEventListener("dispose",ne),_.__depthDisposeCallback=ne}_.__boundDepthTexture=G}if(b.depthTexture&&!_.__autoAllocateDepthBuffer)if(L)for(let G=0;G<6;G++)Ie(_.__webglFramebuffer[G],b,G);else{let G=b.texture.mipmaps;G&&G.length>0?Ie(_.__webglFramebuffer[0],b,0):Ie(_.__webglFramebuffer,b,0)}else if(L){_.__webglDepthbuffer=[];for(let G=0;G<6;G++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[G]),_.__webglDepthbuffer[G]===void 0)_.__webglDepthbuffer[G]=i.createRenderbuffer(),Te(_.__webglDepthbuffer[G],b,!1);else{let ne=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer[G];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,ne,i.RENDERBUFFER,J)}}else{let G=b.texture.mipmaps;if(G&&G.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),Te(_.__webglDepthbuffer,b,!1);else{let ne=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,ne,i.RENDERBUFFER,J)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Xe(b,_,L){let G=n.get(b);_!==void 0&&le(G.__webglFramebuffer,b,b.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&me(b)}function Ge(b){let _=b.texture,L=n.get(b),G=n.get(_);b.addEventListener("dispose",T);let ne=b.textures,J=b.isWebGLCubeRenderTarget===!0,fe=ne.length>1;if(fe||(G.__webglTexture===void 0&&(G.__webglTexture=i.createTexture()),G.__version=_.version,o.memory.textures++),J){L.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer[ie]=[];for(let Ee=0;Ee<_.mipmaps.length;Ee++)L.__webglFramebuffer[ie][Ee]=i.createFramebuffer()}else L.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){L.__webglFramebuffer=[];for(let ie=0;ie<_.mipmaps.length;ie++)L.__webglFramebuffer[ie]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(fe)for(let ie=0,Ee=ne.length;ie<Ee;ie++){let Be=n.get(ne[ie]);Be.__webglTexture===void 0&&(Be.__webglTexture=i.createTexture(),o.memory.textures++)}if(b.samples>0&&Oe(b)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ie=0;ie<ne.length;ie++){let Ee=ne[ie];L.__webglColorRenderbuffer[ie]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[ie]);let Be=s.convert(Ee.format,Ee.colorSpace),ce=s.convert(Ee.type),_e=w(Ee.internalFormat,Be,ce,Ee.colorSpace,b.isXRRenderTarget===!0),De=A(b);i.renderbufferStorageMultisample(i.RENDERBUFFER,De,_e,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,L.__webglColorRenderbuffer[ie])}i.bindRenderbuffer(i.RENDERBUFFER,null),b.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),Te(L.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,G.__webglTexture),$(i.TEXTURE_CUBE_MAP,_);for(let ie=0;ie<6;ie++)if(_.mipmaps&&_.mipmaps.length>0)for(let Ee=0;Ee<_.mipmaps.length;Ee++)le(L.__webglFramebuffer[ie][Ee],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ee);else le(L.__webglFramebuffer[ie],b,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);d(_)&&m(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(fe){for(let ie=0,Ee=ne.length;ie<Ee;ie++){let Be=ne[ie],ce=n.get(Be),_e=i.TEXTURE_2D;(b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(_e=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(_e,ce.__webglTexture),$(_e,Be),le(L.__webglFramebuffer,b,Be,i.COLOR_ATTACHMENT0+ie,_e,0),d(Be)&&m(_e)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(ie=b.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,G.__webglTexture),$(ie,_),_.mipmaps&&_.mipmaps.length>0)for(let Ee=0;Ee<_.mipmaps.length;Ee++)le(L.__webglFramebuffer[Ee],b,_,i.COLOR_ATTACHMENT0,ie,Ee);else le(L.__webglFramebuffer,b,_,i.COLOR_ATTACHMENT0,ie,0);d(_)&&m(ie),t.unbindTexture()}b.depthBuffer&&me(b)}function te(b){let _=b.textures;for(let L=0,G=_.length;L<G;L++){let ne=_[L];if(d(ne)){let J=S(b),fe=n.get(ne).__webglTexture;t.bindTexture(J,fe),m(J),t.unbindTexture()}}}let oe=[],re=[];function ye(b){if(b.samples>0){if(Oe(b)===!1){let _=b.textures,L=b.width,G=b.height,ne=i.COLOR_BUFFER_BIT,J=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=n.get(b),ie=_.length>1;if(ie)for(let Be=0;Be<_.length;Be++)t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,fe.__webglMultisampledFramebuffer);let Ee=b.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglFramebuffer);for(let Be=0;Be<_.length;Be++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(ne|=i.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(ne|=i.STENCIL_BUFFER_BIT)),ie){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,fe.__webglColorRenderbuffer[Be]);let ce=n.get(_[Be]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ce,0)}i.blitFramebuffer(0,0,L,G,0,0,L,G,ne,i.NEAREST),c===!0&&(oe.length=0,re.length=0,oe.push(i.COLOR_ATTACHMENT0+Be),b.depthBuffer&&b.resolveDepthBuffer===!1&&(oe.push(J),re.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,re)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,oe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ie)for(let Be=0;Be<_.length;Be++){t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.RENDERBUFFER,fe.__webglColorRenderbuffer[Be]);let ce=n.get(_[Be]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,fe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Be,i.TEXTURE_2D,ce,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,fe.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&c){let _=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function A(b){return Math.min(r.maxSamples,b.samples)}function Oe(b){let _=n.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function we(b){let _=o.render.frame;h.get(b)!==_&&(h.set(b,_),b.update())}function Ve(b,_){let L=b.colorSpace,G=b.format,ne=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||L!==Ii&&L!==Kn&&(rt.getTransfer(L)===ot?(G!==mn||ne!==en)&&He("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):We("WebGLTextures: Unsupported texture color space:",L)),_}function F(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(l.width=b.naturalWidth||b.width,l.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(l.width=b.displayWidth,l.height=b.displayHeight):(l.width=b.width,l.height=b.height),l}this.allocateTextureUnit=H,this.resetTextureUnits=B,this.setTexture2D=U,this.setTexture2DArray=O,this.setTexture3D=D,this.setTextureCube=Z,this.rebindTextures=Xe,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=te,this.updateMultisampleRenderTarget=ye,this.setupDepthRenderbuffer=me,this.setupFrameBufferTexture=le,this.useMultisampledRTT=Oe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function f_(i,e){function t(n,r=Kn){let s,o=rt.getTransfer(r);if(n===en)return i.UNSIGNED_BYTE;if(n===ta)return i.UNSIGNED_SHORT_4_4_4_4;if(n===na)return i.UNSIGNED_SHORT_5_5_5_1;if(n===rc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===sc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===nc)return i.BYTE;if(n===ic)return i.SHORT;if(n===Sr)return i.UNSIGNED_SHORT;if(n===ea)return i.INT;if(n===En)return i.UNSIGNED_INT;if(n===Tn)return i.FLOAT;if(n===Fn)return i.HALF_FLOAT;if(n===oc)return i.ALPHA;if(n===ac)return i.RGB;if(n===mn)return i.RGBA;if(n===In)return i.DEPTH_COMPONENT;if(n===xi)return i.DEPTH_STENCIL;if(n===lc)return i.RED;if(n===ia)return i.RED_INTEGER;if(n===Bi)return i.RG;if(n===ra)return i.RG_INTEGER;if(n===sa)return i.RGBA_INTEGER;if(n===vs||n===ys||n===Ms||n===bs)if(o===ot)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===vs)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ys)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ms)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===vs)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ys)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ms)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===oa||n===aa||n===la||n===ca)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===oa)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===aa)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===la)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ca)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ha||n===ua||n===da||n===fa||n===pa||n===ma||n===ga)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ha||n===ua)return o===ot?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===da)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===fa)return s.COMPRESSED_R11_EAC;if(n===pa)return s.COMPRESSED_SIGNED_R11_EAC;if(n===ma)return s.COMPRESSED_RG11_EAC;if(n===ga)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===_a||n===xa||n===va||n===ya||n===Ma||n===ba||n===Sa||n===wa||n===Ea||n===Ta||n===Aa||n===Ra||n===Ca||n===Pa)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===_a)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===xa)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===va)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ya)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ma)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ba)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Sa)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===wa)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ea)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ta)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Aa)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ra)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ca)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Pa)return o===ot?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ia||n===Da||n===La)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Ia)return o===ot?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Da)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===La)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Na||n===Ua||n===Fa||n===Oa)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Na)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ua)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Fa)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Oa)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===wr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}var p_=`
void main() {
