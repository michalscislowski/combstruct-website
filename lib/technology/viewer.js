...
import {manufacturingScene,flowSteps} from './manufacturing.js';
...
function buildScene(){
 ...
 try{
  ...
  current=technology==='combstruct'?manualScene(topic,variant):technology==='bim'?bimScene(bimView,selectInfo):manufacturingScene(flowStage);
