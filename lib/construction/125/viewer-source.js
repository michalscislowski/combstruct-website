...
window.combstruct125={model,setView,setBattens,setMode:setView,reset,getState:()=>({ready:true,view,boardCount:boards.length,battensVisible,battenCount:battenLayer.parts.length,battenMetres:battenLayer.quantities.lengthM,battenSheets:battenLayer.quantities.sheets,insulationCount:model.insulationCount,visibleInsulation:view==='insulation'?model.insulationCount:0,dimensions,rooms:model.rooms,drawCalls:renderer.info.render.calls,triangles:renderer.info.render.triangles,validation:model.validation||null})};
