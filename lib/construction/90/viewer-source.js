...
window.combstruct90={model,setView,setMode:setView,reset,getState:()=>({ready:true,view,boardCount:boards.length,dimensions,rooms:model.rooms,drawCalls:renderer.info.render.calls,triangles:renderer.info.render.triangles,validation:model.validation||null})};
