...
export function buildStructure(materials={},options={}){
  ...
  for(const w of specs){
    ...
    const panel=wallPanel(engine,w,specs,{target,base,modules:n,cap:!!(isUpper&&w.exterior),holes,frameOpenings:true,planes:isUpper?roofPlanes:[],verticalGaps:isUpper&&w.exterior?[{at:8,side:'right',layer:0}]:[],continueFromBelow:continues});
