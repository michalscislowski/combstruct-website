...
export function buildStructure(materials = {}, options = {}) {
  ...
  openings.front = [hole('front','window',1,3,3*P+T,6*P-T,'front-window-left'), hole('front','door',5,8,H,6*P-T,'entrance'), hole('front','window',10,12,3*P+T,6*P-T,'front-window-right')];
