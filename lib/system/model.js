...
import {wallBattens,ribBattens,BATTEN} from '../construction/battens.js';
...
export function battenPartsForHouse(house) {
 ...
 walls.forEach((wall,wi)=>{
  ...
  for(const original of wallBattens([...ribs.values()],wall.holes)) {
   ...
   parts.push(...clearBatten({...part,surface:'wall',wall:wi,wallId:wall.id,wallAxis:wall.axis,center:center.toArray(),size},solids));
  }
 });
 return [...parts,...roofBattensForHouse(house,solids)];
}
